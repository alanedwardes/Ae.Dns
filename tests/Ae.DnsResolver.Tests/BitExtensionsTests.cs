...
namespace Ae.DnsResolver.Tests
{
    public class BitExtensionsTests
    {
        ...
        [Theory]
        [InlineData("1000000000000000", 0, 1,   "1000000000000000")]
        [InlineData("0111111111111111", 0, 1,   "0000000000000000")]
        ...
        [InlineData("1000000000000000", 1, 2,   "1000000000000000", "1100000000000000")]
        [InlineData("1010000000000000", 1, 2,   "1000000000000000", "1110000000000000")]
        [InlineData("0010000000000000", 1, 2,   "1000000000000000", "0110000000000000")]
